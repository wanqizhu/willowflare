...
var ready = function(){
    ...
    $(".popupButton").on('click',function(e){
        ...
        // so we haev to make a "switch" statement for every popup we want -- ugh
        var source = $(this).attr('imagesrc')

        if (source == 'TermsofUse.jpg') {
            $("#infographicImage").attr('src', "/assets/TermsofUse-0393bc96c61eb30327ae297c89fb48eba5c9a8ea3905c7417acc20eb169fffd9.jpg");
        } else if (source == 'potion.png') {
            $("#infographicImage").attr('src', "/assets/potion-01f502e0d5db57323a9f305ea3b6048215689c0009137a3d3aa3ef6a665dc9db.png");
        }
